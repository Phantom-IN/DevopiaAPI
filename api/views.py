...
def index(request):
    return JsonResponse({'Server Health': 'Excellent'})
...
def add_marks(request):
    ...
    if request.method == 'POST':
        ...
        if user_type == 'teacher':
            # Handle getting all students' marks for each subject
            ...
            for student in students:
                ...
                for subject in subjects:
                    ...
                    if student_marks:
                        total_marks += student_marks.marks
